...
@Set WORKDRIVE=C
@REM Set JDK="%WORKDRIVE%:\Program Files\JetBrains\IntelliJ IDEA 2019.3.1\jbr"
@Set JDK="%WORKDRIVE%:\Program Files\Java\jdk-11.0.5"
...
@set JAVAPROJ=%WORKDRIVE%:\\Users\Aguia\IdeaProjects\%JAVAPROJ_NAME%
@Set PACKAGE=rmi
@Set PACKAGE_PREFIX=edu.ufp.inf.sd
@Set PACKAGE_PREFIX_FOLDERS=edu/ufp/inf/sd
@Set SERVICE_NAME_ON_REGISTRY=TaskGroupService
...
@rem CLASSPATH=.;%JAVAPROG_CLASSES_FOLDER%
